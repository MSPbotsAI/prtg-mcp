...
PRTGError, independent of any real HTTP request.
"""

import pytest

from prtg_mcp.api_client import PRTGError
from prtg_mcp.config import Settings
from prtg_mcp.server import create_mcp_server

EXPECTED_TOOLS = {
    "prtg_get_sensors": set(),
    "prtg_get_devices": set(),
    "prtg_get_sensor_historic_data": {"sensor_id", "start_date", "end_date"},
}
...
def test_error_envelope_mapping(status_code, expected_code, expected_retryable):
    ...
    err = PRTGError(status_code, "boom")
